...
public class PotionsRegistry {
    ...
    //Attack range
    public static final RegistryObject<Potion> ATTACK_RANGE_POTION = preInit.attackRangePotionEnabled ?
